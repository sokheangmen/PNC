...
# pic_giant = tk.PhotoImage(file="img/giant-stick.png")
# player_mario = tk.PhotoImage(file="img/mario-hd.png")
...
game_over = tk.PhotoImage(file="img/Game-lose.png")

pic_diamond = tk.PhotoImage(file="img/daimond.png")
pic_life = tk.PhotoImage(file="img/heart.png")
pic_giant = tk.PhotoImage(file="img/giant-stick.png")
player_mario = tk.PhotoImage(file="img/mario-hd.png")
